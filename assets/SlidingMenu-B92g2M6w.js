import{a as v,T as oi,j as h,U as De,V as Se,W as ri,X as Ae,Y as V,Z as k,a0 as nt,a1 as be,a2 as rt,a3 as mt,a4 as z,a5 as Re,a6 as ai,a7 as li,a8 as Le,a9 as ci,aa as gt,ab as xt,ac as Lt,ad as hi,d as T,b as yt,l as di,ae as ui,G as mi,af as pi,g as fi,ag as yi}from"./index-DZPRBcbd.js";import{P as pt,e as _,c as ot,f as gi,g as Ve}from"./InvoiceStatus-s2ERXa1g.js";import{L as M,C as Be,S as Ie,A as ft,a as xi,b as Vt,c as Bt,I as wt}from"./editPageStyles-DhfyCFBO.js";import{c as vt,v as It}from"./utilityFunctions-bHTjV7_5.js";import{u as kt}from"./useMutation-7HDtl_nG.js";import{i as F,b as bt,d as vi,e as Pi,f as ke,p as Ci,s as ji,m as Ti,h as A,j as Dt,k as S,l as Ei,n as wi,o as Di,q as Mt,r as Me,F as Fe,t as Ft,u as Si,v as Ne,w as $e,x as Oe,y as Ai,z as Nt,S as bi,A as Ri,B as O,C as at,D as lt,E as $t,G as Li,H as Vi,I as Bi,J as U,K as Ii,c as ki,g as Mi,a as Fi}from"./create-visual-element-CmAIHtGO.js";class Ni extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,a=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=a-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function $i({children:t,isPresent:e,anchorX:i}){const s=v.useId(),a=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(oi);return v.useInsertionEffect(()=>{const{width:r,height:o,top:l,left:c,right:d}=u.current;if(e||!a.current||!r||!o)return;const m=i==="left"?`left: ${c}`:`right: ${d}`;a.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
...
`;function Cn({invoice:t}){var n,r,o,l;const e=yt(),{formState:{errors:i},register:s}=_(),{isDraft:a}=ot(),u=h.jsxs(N,{style:{width:e<768?"100%":""},className:"company-country",children:[h.jsx(M,{htmlFor:"CompanyCountry",style:{color:i!=null&&i.country?"#EC5757":""},children:"Country"}),h.jsx(Be,{id:"CompanyCountry",type:"text",style:{border:i!=null&&i.country?"1px solid #EC5757":"",width:e<768?"100%":""},defaultValue:t?(n=t==null?void 0:t.senderAddress)==null?void 0:n.country:"",...s("country",{required:!a,pattern:/^[A-Za-z0-9 ]+$/i,maxLength:30})})]});return h.jsxs(h.Fragment,{children:[h.jsxs(N,{className:"company-street-address",children:[h.jsx(M,{htmlFor:"streetAddress",style:{color:i!=null&&i.streetAddress?"#EC5757":""},children:"Street Address"}),h.jsx(Ie,{id:"streetAddress",style:{border:i!=null&&i.streetAddress?"1px solid #EC5757":""},defaultValue:t?(r=t==null?void 0:t.senderAddress)==null?void 0:r.street:"",...s("streetAddress",{required:!a,pattern:/^[A-Za-z0-9 ]+$/i,maxLength:50})})]}),h.jsxs(Rt,{children:[h.jsxs(Js,{children:[h.jsxs(W,{className:"company-city",children:[h.jsx(M,{htmlFor:"companyCity",style:{color:i!=null&&i.city?"#EC5757":""},children:"City"}),h.jsx(ft,{id:"companyCity",style:{border:i!=null&&i.city?"1px solid #EC5757":""},defaultValue:t?(o=t==null?void 0:t.senderAddress)==null?void 0:o.city:"",type:"text",...s("city",{required:!a,pattern:/[\w ]*/i,maxLength:30})})]}),h.jsxs(W,{style:{justifySelf:"flex-end"},className:"company-postal-code",children:[h.jsx(M,{htmlFor:"CompanyPostalCode",style:{color:i!=null&&i.postalCode?"#EC5757":""},children:"Post Code"}),h.jsx(ft,{id:"CompanyPostalCode",style:{border:i!=null&&i.postalCode?"1px solid #EC5757":""},type:"text",defaultValue:t?(l=t==null?void 0:t.senderAddress)==null?void 0:l.postCode:"",...s("postalCode",{required:!a,pattern:/^\w+[\w ]+$/i,maxLength:10,minLength:5})})]})]}),e<768&&h.jsx(N,{className:"company-country-container",children:u}),e>=768&&h.jsx(W,{className:"company-country-container",children:u})]})]})}const Pe=T.div`
  display: flex;
  width: 100%;
  flex-wrap: wrap;
  align-items: center;
...
`,on=T.p`
  ...
  letter-spacing: -0.25px;
  margin-left: 0.25rem;
`;function rn({items:t,append:e}){const{clearErrors:i}=_(),{formState:{submitCount:s}}=gi(),a=()=>{e({id:"",name:"",quantity:"",price:"",total:""}),i("itemsError")};return h.jsx(nn,{onClick:a,type:"button",style:{border:s>0&&t.length===0?"1px solid red":"1px solid transparent"},children:h.jsx(on,{children:"+ Add New Item"})})}const an=T.div`
  display: grid;
  width: 100%;
  border-radius: 8px;
...
`;function ni({isDraft:t,invoice:e,isEditOpen:i}){const{formState:s,register:a,watch:u,clearErrors:n,setError:r,reset:o}=_(),{fields:l,remove:c,append:d}=Ve({name:"items",rules:{required:!0,minLength:1}}),{errors:m,isSubmitting:p}=s,y=u("items",[]),g=yt(),P=v.useRef(!0);v.useEffect(()=>{!l.length&&!P.current?r("myFieldArray",{type:"required",message:"At least one item is required"}):n("myFieldArray"),P.current&&(P.current=!1)},[l,p]),v.useEffect(()=>{e&&i?o({items:e.items.map(f=>({id:f.id,name:f.name,quantity:f.quantity,price:f.price,total:f.total}))}):i||o({items:[]})},[e,i,o]);const C=f=>{var E,j,x,w,D,R,$,G,H,X,Y,Z,K,Q;return h.jsxs(Pe,{children:[h.jsxs(tt,{style:{width:"100%",marginBottom:"1.5rem"},children:[h.jsx(ut,{style:{marginBottom:"1rem"},children:"Item Name"}),h.jsx(Ce,{...a(`items[${f}].name`,{required:!t}),placeholder:"Item name",defaultValue:e?(j=(E=e==null?void 0:e.items)==null?void 0:E[f])==null?void 0:j.name:"",type:"text",style:{border:Array.isArray(m.items)&&((w=(x=m==null?void 0:m.items)==null?void 0:x[f])!=null&&w.name)?"1px solid #EC5757":""}})]}),h.jsxs(sn,{children:[h.jsxs(tt,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Qty."}),h.jsx(At,{...a(`items[${f}].quantity`,{required:!t,max:100}),placeholder:"0",type:"text",style:{border:Array.isArray(m.items)&&((R=(D=m==null?void 0:m.items)==null?void 0:D[f])!=null&&R.quantity)?"1px solid #EC5757":""},defaultValue:e?(G=($=e==null?void 0:e.items)==null?void 0:$[f])==null?void 0:G.quantity:""})]}),h.jsxs(tt,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Price"}),h.jsx(je,{...a(`items[${f}].price`,{required:!t,max:1e5}),placeholder:"0.00",type:"text",defaultValue:e?(X=(H=e==null?void 0:e.items)==null?void 0:H[f])==null?void 0:X.price:"",style:{border:Array.isArray(m.items)&&((Z=(Y=m==null?void 0:m.items)==null?void 0:Y[f])!=null&&Z.price)?"1px solid #EC5757":""}})]}),h.jsxs(en,{style:{width:"fit-content"},children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Total"}),h.jsx(Te,{children:(Number((K=y==null?void 0:y[f])==null?void 0:K.quantity)*Number((Q=y==null?void 0:y[f])==null?void 0:Q.price)).toFixed(2)})]})]}),h.jsxs(tt,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"  "}),h.jsx(Ee,{name:"removeButton",onClick:()=>c(f),children:we})]})]})},b=f=>{var E,j,x,w,D,R,$,G,H,X,Y,Z,K,Q;return h.jsx(Pe,{children:h.jsxs(tn,{children:[h.jsx(Ce,{...a(`items[${f}].name`,{required:!t}),placeholder:"Item name",defaultValue:e?(j=(E=e==null?void 0:e.items)==null?void 0:E[f])==null?void 0:j.name:"",type:"text",style:{border:Array.isArray(m.items)&&((w=(x=m==null?void 0:m.items)==null?void 0:x[f])!=null&&w.name)?"1px solid #EC5757":""}}),h.jsx(At,{...a(`items[${f}].quantity`,{required:!t,max:100}),placeholder:"0",type:"text",style:{border:Array.isArray(m.items)&&((R=(D=m==null?void 0:m.items)==null?void 0:D[f])!=null&&R.quantity)?"1px solid #EC5757":""},defaultValue:e?(G=($=e==null?void 0:e.items)==null?void 0:$[f])==null?void 0:G.quantity:0}),h.jsx(je,{...a(`items[${f}].price`,{required:!t,max:1e5}),placeholder:"0.00",type:"text",defaultValue:e?(X=(H=e==null?void 0:e.items)==null?void 0:H[f])==null?void 0:X.price:0,style:{border:Array.isArray(m.items)&&((Z=(Y=m==null?void 0:m.items)==null?void 0:Y[f])!=null&&Z.price)?"1px solid #EC5757":""}}),h.jsx(Te,{children:(Number((K=y==null?void 0:y[f])==null?void 0:K.quantity)*Number((Q=y==null?void 0:y[f])==null?void 0:Q.price)).toFixed(2)}),h.jsx(Ee,{name:"removeButton",onClick:()=>c(f),children:we})]})})};return h.jsxs(h.Fragment,{children:[h.jsx("ul",{style:{listStyle:"none",marginLeft:"0",paddingLeft:0},children:l.map((f,E)=>h.jsx("li",{"data-testid":"invoice-item",children:h.jsxs("div",{children:[g<600&&C(E),g>=600&&b(E)]})},f.id))}),h.jsx(rn,{append:d,items:e?e.items:[]})]})}ni.propTypes={isDraft:pt.bool.isRequired,isEditOpen:pt.bool};const dn=({className:t})=>h.jsxs(ln,{className:t,children:[h.jsx(ut,{children:"Item Name"}),h.jsx(ut,{children:"Qty."}),h.jsx(ut,{children:"Price"}),h.jsx(q,{children:"Total"})]});function Tn({invoice:t,isEditOpen:e=!1}){const{isDraft:i}=ot();return h.jsxs(an,{"data-testid":"items-container",children:[h.jsx(hn,{children:"Item List"}),h.jsx(dn,{className:"desktop-only-label"}),h.jsx(cn,{children:h.jsx(ni,{isDraft:i,invoice:t,isEditOpen:e})})]})}function un({isEditOpen:t}){const{formState:{errors:e}}=_(),i=()=>Object.keys(e).find(s=>s!=="myFieldArray"&&s!=="items");return h.jsxs(xi,{children:[h.jsx(Vt,{style:{visibility:(i()||e.items)&&t?"visible":"hidden"},children:"- All fields must be added"}),h.jsx(Vt,{style:{visibility:e.myFieldArray&&t?"visible":"hidden"},children:"- An item must be added"})]})}un.propTypes={isEditOpen:pt.bool.isRequired};function En({invoice:t}){var n,r,o,l,c,d;const e=yt(),{formState:{errors:i},register:s}=_(),{isDraft:a}=ot(),u=h.jsxs(N,{style:{width:e<768?"100%":""},className:"client-country",children:[h.jsx(M,{htmlFor:"clientCountry",style:{color:i.clientCountry?"#EC5757":""},children:"Country"}),h.jsx(Be,{id:"clientCountry",$long:!1,style:{border:i!=null&&i.clientCountry?"1px solid #EC5757":"",width:e<768?"100%":""},type:"text",defaultValue:t?(n=t==null?void 0:t.clientAddress)==null?void 0:n.country:"",...s("clientCountry",{required:!a,pattern:/^[A-Za-z0-9 ]+$/i,maxLength:30})})]});return h.jsxs(h.Fragment,{children:[h.jsxs(N,{className:"client-name",children:[h.jsx(M,{htmlFor:"clientName",style:{color:i.clientName?"#EC5757":""},children:"Client's Name"}),((r=i.clientName)==null?void 0:r.type)==="required"&&h.jsx(Bt,{children:"can't be empty"}),h.jsx(wt,{id:"clientName",$long:!0,style:{border:i.clientName?"1px solid #EC5757":""},type:"text",defaultValue:t?t.clientName:"",...s("clientName",{required:!a})})]}),h.jsxs(N,{className:"client-email",children:[h.jsx(M,{htmlFor:"clientEmail",style:{color:i.clientEmail?"#EC5757":""},children:"Client's Email"}),((o=i.clientEmail)==null?void 0:o.type)==="pattern"&&h.jsx(Bt,{style:{position:"absolute",top:"-8px"},children:"Invalid email"}),h.jsx(wt,{id:"clientEmail",$long:!0,style:{border:i.clientEmail?"1px solid #EC5757":""},type:"text",defaultValue:t?t.clientEmail:"",...s("clientEmail",{required:!a,pattern:/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/})})]}),h.jsxs(N,{className:"client-street-address",children:[h.jsx(M,{htmlFor:"clientStreetAddress",style:{color:i.clientStreetAddress?"#EC5757":""},children:"Street Address"}),h.jsx(Ie,{id:"clientStreetAddress",style:{border:i.clientStreetAddress?"1px solid #EC5757":""},defaultValue:t?(l=t==null?void 0:t.clientAddress)==null?void 0:l.street:"",...s("clientStreetAddress",{required:!a})})]}),h.jsxs(Rt,{children:[h.jsxs(W,{className:"clientCity",children:[h.jsx(M,{htmlFor:"clientCity",style:{color:i.clientCity?"#EC5757":""},children:"City"}),h.jsx(ft,{id:"clientCity",style:{border:i.clientCity?"1px solid #EC5757":""},type:"text",defaultValue:t?(c=t==null?void 0:t.clientAddress)==null?void 0:c.city:"",...s("clientCity",{required:!a,pattern:/[\w ]*/i,maxLength:30})})]}),h.jsxs(W,{className:"clientPostalCode",children:[h.jsx(M,{htmlFor:"clientPostalCode",style:{color:i.clientPostalCode?"#EC5757":""},children:"Post Code"}),h.jsx(ft,{id:"clientPostalCode",style:{border:i.clientPostalCode?"1px solid #EC5757":""},type:"text",defaultValue:t?(d=t==null?void 0:t.clientAddress)==null?void 0:d.postCode:"",...s("clientPostalCode",{required:!a,pattern:/^\w+[\w ]+$/i,maxLength:10,minLength:5})})]}),e<768&&h.jsx(N,{className:"client-country",children:u}),e>=768&&h.jsx(W,{className:"client-country",children:u})]})]})}function wn({invoice:t}){const{formState:{errors:e},register:i}=_(),{isDraft:s}=ot();return h.jsx(h.Fragment,{children:h.jsxs(N,{className:"project-description",children:[h.jsx(M,{htmlFor:"projectDescription",style:{color:e.projectDescription?"#EC5757":""},children:"Project Description"}),h.jsx(wt,{id:"projectDescription",type:"text",defaultValue:t==null?void 0:t.description,...i("projectDescription",{required:!s}),style:{border:e.projectDescription?"1px solid #EC5757":""}})]})})}const Dn=()=>{const{id:t}=di(),{startDate:e,setIsDraft:i,setIsNewInvoiceOpen:s,selectedPaymentOption:a,setSelectedPaymentOption:u,methods:n}=ot(),{control:r,trigger:o,reset:l,watch:c,setError:d,clearErrors:m,getValues:p}=n,{replace:y}=Ve({control:r,name:"items"}),g=c(),[P]=kt(yi,{refetchQueries:[{query:fi}],onError:x=>{console.error(x)}}),[C]=kt(pi,{update:(x,{data:{editInvoice:w}})=>{x.writeQuery({query:mi,variables:{getInvoiceById:w.id},data:{getInvoiceById:w}})},onError:x=>{console.error(x)}}),b=()=>{u(1),l(),m(),s(!1)},f=async x=>{if(ui.flushSync(()=>i(!1)),x=p(),!x.items){d("items",{type:"custom",message:"An item must be added"});return}if(await o()){const D=vt(x,e,a);D.items=D.items.map(R=>({...R,quantity:Number(R.quantity),price:Number(R.price)})),D.status="pending";try{await P({variables:{...D}}),b(),y([{id:It(),name:"",quantity:0,price:0,total:0}])}catch(R){console.error(R)}}},E=async()=>{m();const x=p();x.items||(x.items=[{id:"",name:"",quantity:0,price:0,total:0}]);const w=vt(x,e,a);w.status="draft";try{await P({variables:{...w}}),b(),y([{id:It(),name:"",quantity:0,price:0,total:0}])}catch(D){console.error(D)}},j=async x=>{if(await o()){const D=vt(x,e,a);D.id=String(t),D.status="pending";try{await C({variables:{...D}}),s(!1)}catch(R){console.error(R)}}};return v.useEffect(()=>{g.items?m("items"):d("items",{type:"custom",message:"An item must be added"})},[g.items,d]),{methods:n,onSubmit:f,onSubmitDraft:E,onSubmitUpdate:j}},Sn=({children:t})=>{const e=yt();let i=700;e<=616?i=e:e<=768?i=616:i=700;const s={hidden:{x:`${-i}px`},visible:{x:"0"},exit:{x:`${-i}px`}};return h.jsxs(h.Fragment,{children:[h.jsx(ve.div,{initial:{opacity:0},animate:{opacity:.5},exit:{opacity:0},transition:{duration:.3,ease:"easeInOut"},style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",backgroundColor:"#000",zIndex:1e3,cursor:"pointer"}},"overlay"),h.jsx(ve.div,{variants:s,initial:"hidden",animate:"visible",exit:"exit",transition:{type:"tween",duration:.3,ease:"easeInOut"},style:{position:"fixed",top:0,left:0,width:`${i}px`,height:"100%",color:"#ecf0f1",padding:"20px",zIndex:1001,boxShadow:"2px 0 5px rgba(0,0,0,0.3)"},children:t},"sidebar")]})};export{vn as A,Cn as C,wn as D,Tn as E,un as F,Sn as S,En as a,W as b,jn as c,Dn as u};
