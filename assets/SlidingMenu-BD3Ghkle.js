const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NewInvoiceBottomMenu-CTqpUfo5.js","assets/index-DPd1qPLZ.js","assets/index-BgypsdHM.css","assets/InvoiceStatus-nCRc6NUy.js","assets/CancelButton-Qfq45QhE.js","assets/defaultValues-DmTNWt_V.js","assets/utilityFunctions-CAPD2Jrd.js","assets/ReactToastify-CXwMS95O.js","assets/ReactToastify-CZOjr4-t.css","assets/editPageStyles-C4V02GEE.js","assets/create-visual-element-D-S0tcFb.js","assets/DateAndPayment-31rNoTPe.js"])))=>i.map(i=>d[i]);
import{c as x,U as Je,j as l,V as fe,W as ye,X as Ke,Y as ge,Z as A,a0 as B,a1 as Y,a2 as xe,a3 as Z,a4 as st,a5 as z,a6 as ve,a7 as ti,a8 as ei,a9 as Pe,aa as ii,ab as at,ac as lt,ad as Pt,ae as si,d as P,f as ot,R as je,h as Ce}from"./index-DPd1qPLZ.js";import{P as Te,d as k,b as M,e as ni,f as oi}from"./InvoiceStatus-nCRc6NUy.js";import{L as V,C as we,a as jt,I as pt,S as Ee,A as nt,b as ri,c as Ct,E as ai,B as Tt}from"./editPageStyles-C4V02GEE.js";import{i as I,b as gt,d as li,e as ci,f as De,p as di,s as hi,m as ui,h as E,j as ft,k as w,l as mi,n as pi,o as fi,q as wt,r as Se,F as Ae,t as Et,u as yi,v as be,w as Re,x as Le,y as gi,z as Dt,S as xi,A as vi,B as $,C as Q,D as J,E as St,G as Pi,H as ji,I as Ci,J as O,K as Ti,c as wi,g as Ei,a as Di}from"./create-visual-element-D-S0tcFb.js";class Si extends x.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,h=this.props.sizeRef.current;h.height=i.offsetHeight||0,h.width=i.offsetWidth||0,h.top=i.offsetTop,h.left=i.offsetLeft,h.right=o-h.width-h.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Ai({children:t,isPresent:e,anchorX:i}){const s=x.useId(),o=x.useRef(null),h=x.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=x.useContext(Je);return x.useInsertionEffect(()=>{const{width:r,height:a,top:c,left:d,right:u}=h.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${d}`:`right: ${u}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
