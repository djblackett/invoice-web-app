const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NewInvoiceBottomMenu-9xDub9Rf.js","assets/index-BGXO2lPp.js","assets/index-BgypsdHM.css","assets/InvoiceStatus-BYFB8oeg.js","assets/CancelButton-DCVx1bk1.js","assets/defaultValues-DzdHoEjO.js","assets/utilityFunctions-BAfcw2Vo.js","assets/useMutation-DS9AGViE.js","assets/editPageStyles-SK7J9V0i.js","assets/create-visual-element-D1gbSJ56.js","assets/DateAndPayment-DScRaJX2.js"])))=>i.map(i=>d[i]);
import{a as x,T as Ke,j as l,U as ye,V as ge,W as ti,X as xe,Y as A,Z as B,a0 as Y,a1 as ve,a2 as Z,a3 as st,a4 as z,a5 as Pe,a6 as ei,a7 as ii,a8 as je,a9 as si,aa as lt,ab as ct,ac as jt,ad as ni,d as P,b as rt,R as Ce,f as Te}from"./index-BGXO2lPp.js";import{P as nt,e as k,c as M,f as oi,g as ri}from"./InvoiceStatus-BYFB8oeg.js";import{L as V,C as we,a as Ct,I as ft,S as Ee,A as ot,b as ai,c as Tt,E as li,B as wt}from"./editPageStyles-SK7J9V0i.js";import{i as I,b as xt,d as ci,e as di,f as De,p as hi,s as ui,m as mi,h as E,j as yt,k as w,l as pi,n as fi,o as yi,q as Et,r as Se,F as Ae,t as Dt,u as gi,v as be,w as Re,x as Le,y as xi,z as St,S as vi,A as Pi,B as $,C as Q,D as J,E as At,G as ji,H as Ci,I as Ti,J as O,K as wi,c as Ei,g as Di,a as Si}from"./create-visual-element-D1gbSJ56.js";class Ai extends x.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,h=this.props.sizeRef.current;h.height=i.offsetHeight||0,h.width=i.offsetWidth||0,h.top=i.offsetTop,h.left=i.offsetLeft,h.right=o-h.width-h.left}return null}componentDidUpdate(){}render(){return this.props.children}}function bi({children:t,isPresent:e,anchorX:i}){const s=x.useId(),o=x.useRef(null),h=x.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=x.useContext(Ke);return x.useInsertionEffect(()=>{const{width:r,height:a,top:c,left:d,right:u}=h.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${d}`:`right: ${u}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
