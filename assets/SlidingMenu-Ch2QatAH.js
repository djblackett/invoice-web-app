import{a as v,U as oi,j as h,V as De,W as Se,X as ri,Y as Ae,Z as V,$ as k,a0 as nt,a1 as be,a2 as rt,a3 as mt,a4 as z,a5 as Re,a6 as ai,a7 as li,a8 as Le,a9 as ci,aa as gt,ab as xt,ac as Lt,ad as hi,d as T,b as yt,l as di,ae as ui,G as mi,af as pi,g as fi,ag as yi}from"./index-Bo1oAiba.js";import{P as pt,e as _,c as ot,f as gi,g as Ve}from"./InvoiceStatus-BNE0zJRF.js";import{L as M,C as Be,S as Ie,A as ft,a as xi,b as Vt,c as Bt,I as wt}from"./editPageStyles-CR5p9qIm.js";import{c as vt,v as It}from"./utilityFunctions-BzhXeHDk.js";import{u as kt}from"./useMutation-D5_Wo9KX.js";import{i as F,b as bt,d as vi,e as Pi,f as ke,p as ji,s as Ci,m as Ti,h as A,j as Dt,k as S,l as Ei,n as wi,o as Di,q as Mt,r as Me,F as Fe,t as Ft,u as Si,v as Ne,w as $e,x as Oe,y as Ai,z as Nt,S as bi,A as Ri,B as O,C as at,D as lt,E as $t,G as Li,H as Vi,I as Bi,J as U,K as Ii,c as ki,g as Mi,a as Fi}from"./create-visual-element-DNxE0n5E.js";class Ni extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,a=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=a-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function $i({children:t,isPresent:e,anchorX:i}){const s=v.useId(),a=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(oi);return v.useInsertionEffect(()=>{const{width:r,height:o,top:l,left:c,right:d}=u.current;if(e||!a.current||!r||!o)return;const m=i==="left"?`left: ${c}`:`right: ${d}`;a.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
