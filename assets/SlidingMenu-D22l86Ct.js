import{a as v,T as ti,j as h,U as ve,V as Pe,W as ei,X as Ce,Y as L,Z as I,a0 as Z,a1 as je,a2 as Q,a3 as ot,a4 as z,a5 as Te,a6 as ii,a7 as si,a8 as Ee,a9 as ni,aa as ct,ab as dt,ac as Tt,ad as oi,d as C,b as lt,ae as Pt,l as ri,af as ai,G as li,ag as ci,g as di,ah as hi}from"./index-6PDlD84C.js";import{P as rt,e as $,c as K,f as ui,g as we}from"./InvoiceStatus-BlNF5Z0r.js";import{L as k,C as De,S as Se,A as at,a as mi,b as Et,c as wt,I as gt}from"./editPageStyles-AcdAxv9b.js";import{c as ht,v as Dt}from"./utilityFunctions-D51lqgtl.js";import{u as St}from"./useMutation-3ITlW0t2.js";import{i as F,b as Ct,d as pi,e as fi,f as Ae,p as yi,s as gi,m as xi,h as D,j as xt,k as w,l as vi,n as Pi,o as Ci,q as At,r as be,F as Re,t as bt,u as ji,v as Le,w as Ve,x as Be,y as Ti,z as Rt,S as Ei,A as wi,B as O,C as J,D as tt,E as Lt,G as Di,H as Si,I as Ai,J as U,K as bi,c as Ri,g as Li,a as Vi}from"./create-visual-element-Bw0axXRL.js";class Bi extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=o-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Ii({children:t,isPresent:e,anchorX:i}){const s=v.useId(),o=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(ti);return v.useInsertionEffect(()=>{const{width:r,height:a,top:l,left:d,right:c}=u.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${d}`:`right: ${c}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
...
`;function ye({index:t,invoice:e}){var u,n,r,a,l,d,c,m,p;const{register:i,formState:s}=$(),{errors:o}=s;return h.jsxs("div",{style:{position:"relative"},children:[h.jsx(Ke,{...i(`items[${t}].quantity`,{required:!Pt,max:1e3,pattern:{value:/^[0-9]+$/,message:"Only numbers are allowed"}}),placeholder:"0",inputMode:"numeric",type:"text",style:{border:Array.isArray(o.items)&&((n=(u=o==null?void 0:o.items)==null?void 0:u[t])!=null&&n.quantity)?"1px solid #EC5757":""},defaultValue:e?(a=(r=e==null?void 0:e.items)==null?void 0:r[t])==null?void 0:a.quantity:0}),Array.isArray(o.items)&&((d=(l=o==null?void 0:o.items)==null?void 0:l[t])==null?void 0:d.quantity)&&h.jsx("div",{style:{position:"absolute",top:"100%",left:"0",marginTop:"4px",padding:"6px 8px",backgroundColor:"#f8d7da",color:"#721c24",border:"1px solid #f5c6cb",borderRadius:"4px",whiteSpace:"nowrap"},children:(p=(m=(c=o==null?void 0:o.items)==null?void 0:c[t])==null?void 0:m.quantity)==null?void 0:p.message})]})}function ge({index:t,invoice:e}){var u,n,r,a,l,d,c,m,p;const{register:i,formState:s}=$(),{errors:o}=s;return h.jsxs("div",{style:{position:"relative"},children:[h.jsx(Zs,{...i(`items[${t}].price`,{required:!Pt,max:1e5,pattern:{value:/^\$?\d+(,\d{3})*\.?[0-9]?[0-9]?$/,message:"Only numbers are allowed - max 2 decimal places"}}),placeholder:"0.00",inputMode:"numeric",type:"text",defaultValue:e?(n=(u=e==null?void 0:e.items)==null?void 0:u[t])==null?void 0:n.price:0,style:{border:Array.isArray(o.items)&&((a=(r=o==null?void 0:o.items)==null?void 0:r[t])!=null&&a.price)?"1px solid #EC5757":""}}),Array.isArray(o.items)&&((d=(l=o==null?void 0:o.items)==null?void 0:l[t])==null?void 0:d.price)&&h.jsx("div",{style:{position:"absolute",top:"100%",left:"0",marginTop:"4px",padding:"6px 8px",backgroundColor:"#f8d7da",color:"#721c24",border:"1px solid #f5c6cb",borderRadius:"4px",whiteSpace:"nowrap"},children:(p=(m=(c=o==null?void 0:o.items)==null?void 0:c[t])==null?void 0:m.price)==null?void 0:p.message})]})}function xe({index:t,invoice:e}){var u,n,r,a;const{register:i,formState:s}=$(),{errors:o}=s;return h.jsx(Ys,{...i(`items[${t}].name`,{required:!Pt}),placeholder:"Item name",defaultValue:e?(n=(u=e==null?void 0:e.items)==null?void 0:u[t])==null?void 0:n.name:"",type:"text",style:{border:Array.isArray(o.items)&&((a=(r=o==null?void 0:o.items)==null?void 0:r[t])!=null&&a.name)?"1px solid #EC5757":""}})}function Qe({invoice:t,isEditOpen:e}){const{formState:i,watch:s,clearErrors:o,setError:u,reset:n}=$(),{fields:r,remove:a,append:l}=we({name:"items",rules:{required:!0,minLength:1}}),{isSubmitting:d}=i,c=s("items",[]),m=lt(),p=v.useRef(!0);v.useEffect(()=>{!r.length&&!p.current?u("myFieldArray",{type:"required",message:"At least one item is required"}):o("myFieldArray"),p.current&&(p.current=!1)},[r,d]),v.useEffect(()=>{t&&e?n({items:t.items.map(f=>({id:f.id,name:f.name,quantity:f.quantity,price:f.price,total:f.total}))}):e||n({items:[{name:"",price:0,quantity:0,total:0}]})},[t,e,n]);const y=f=>{var x,T;return h.jsxs(ue,{children:[h.jsxs(G,{style:{width:"100%",marginBottom:"1.5rem"},children:[h.jsx(nt,{style:{marginBottom:"1rem"},children:"Item Name"}),h.jsx(xe,{index:f,invoice:t})]}),h.jsxs(Js,{children:[h.jsxs(G,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Qty."}),h.jsx(ye,{index:f,invoice:t})]}),h.jsxs(G,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Price"}),h.jsx(ge,{index:f,invoice:t})]}),h.jsxs(Qs,{style:{width:"fit-content"},children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"Total"}),h.jsx(me,{children:(Number((x=c==null?void 0:c[f])==null?void 0:x.quantity)*Number((T=c==null?void 0:c[f])==null?void 0:T.price)).toFixed(2)})]})]}),h.jsxs(G,{children:[h.jsx(q,{style:{marginBottom:"0.625rem"},children:"  "}),h.jsx(pe,{name:"removeButton",onClick:()=>a(f),children:fe})]})]})},g=f=>{var x,T;return h.jsx(ue,{children:h.jsxs(Ks,{children:[h.jsx(xe,{index:f,invoice:t}),h.jsx(ye,{index:f,invoice:t}),h.jsx(ge,{index:f,invoice:t}),h.jsx(me,{children:(Number((x=c==null?void 0:c[f])==null?void 0:x.quantity)*Number((T=c==null?void 0:c[f])==null?void 0:T.price)).toFixed(2)}),h.jsx(pe,{name:"removeButton",onClick:()=>a(f),children:fe})]})})};return h.jsxs(h.Fragment,{children:[h.jsx("ul",{style:{listStyle:"none",marginLeft:"0",paddingLeft:0},children:r.map((f,x)=>h.jsx("li",{"data-testid":"invoice-item",children:h.jsxs("div",{children:[m<600&&y(x),m>=600&&g(x)]})},f.id))}),h.jsx(sn,{append:l,items:t?t.items:[]})]})}Qe.propTypes={isDraft:rt.bool.isRequired,isEditOpen:rt.bool};const ln=({className:t})=>h.jsxs(on,{className:t,children:[h.jsx(nt,{children:"Item Name"}),h.jsx(nt,{children:"Qty."}),h.jsx(nt,{children:"Price"}),h.jsx(q,{children:"Total"})]});function Pn({invoice:t,isEditOpen:e=!1}){const{isDraft:i}=K();return h.jsxs(nn,{"data-testid":"items-container",children:[h.jsx(an,{children:"Item List"}),h.jsx(ln,{className:"desktop-only-label"}),h.jsx(rn,{children:h.jsx(Qe,{isDraft:i,invoice:t,isEditOpen:e})})]})}function cn({isEditOpen:t}){const{formState:{errors:e}}=$(),i=()=>Object.keys(e).find(s=>s!=="myFieldArray"&&s!=="items");return h.jsxs(mi,{children:[h.jsx(Et,{style:{visibility:(i()||e.items)&&t?"visible":"hidden"},children:"- All fields must be added"}),h.jsx(Et,{style:{visibility:e.myFieldArray&&t?"visible":"hidden"},children:"- An item must be added"})]})}cn.propTypes={isEditOpen:rt.bool.isRequired};function Cn({invoice:t}){var n,r,a,l,d,c;const e=lt(),{formState:{errors:i},register:s}=$(),{isDraft:o}=K(),u=h.jsxs(N,{style:{width:e<768?"100%":""},className:"client-country",children:[h.jsx(k,{htmlFor:"clientCountry",style:{color:i.clientCountry?"#EC5757":""},children:"Country"}),h.jsx(De,{id:"clientCountry",$long:!1,style:{border:i!=null&&i.clientCountry?"1px solid #EC5757":"",width:e<768?"100%":""},type:"text",defaultValue:t?(n=t==null?void 0:t.clientAddress)==null?void 0:n.country:"",...s("clientCountry",{required:!o,pattern:/^[A-Za-z0-9 ]+$/i,maxLength:30})})]});return h.jsxs(h.Fragment,{children:[h.jsxs(N,{className:"client-name",children:[h.jsx(k,{htmlFor:"clientName",style:{color:i.clientName?"#EC5757":""},children:"Client's Name"}),((r=i.clientName)==null?void 0:r.type)==="required"&&h.jsx(wt,{children:"can't be empty"}),h.jsx(gt,{id:"clientName",$long:!0,style:{border:i.clientName?"1px solid #EC5757":""},type:"text",defaultValue:t?t.clientName:"",...s("clientName",{required:!o})})]}),h.jsxs(N,{className:"client-email",children:[h.jsx(k,{htmlFor:"clientEmail",style:{color:i.clientEmail?"#EC5757":""},children:"Client's Email"}),((a=i.clientEmail)==null?void 0:a.type)==="pattern"&&h.jsx(wt,{style:{position:"absolute",top:"-8px"},children:"Invalid email"}),h.jsx(gt,{id:"clientEmail",$long:!0,style:{border:i.clientEmail?"1px solid #EC5757":""},type:"text",defaultValue:t?t.clientEmail:"",...s("clientEmail",{required:!o,pattern:/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/})})]}),h.jsxs(N,{className:"client-street-address",children:[h.jsx(k,{htmlFor:"clientStreetAddress",style:{color:i.clientStreetAddress?"#EC5757":""},children:"Street Address"}),h.jsx(Se,{id:"clientStreetAddress",style:{border:i.clientStreetAddress?"1px solid #EC5757":""},defaultValue:t?(l=t==null?void 0:t.clientAddress)==null?void 0:l.street:"",...s("clientStreetAddress",{required:!o})})]}),h.jsxs(jt,{children:[h.jsxs(W,{className:"clientCity",children:[h.jsx(k,{htmlFor:"clientCity",style:{color:i.clientCity?"#EC5757":""},children:"City"}),h.jsx(at,{id:"clientCity",style:{border:i.clientCity?"1px solid #EC5757":""},type:"text",defaultValue:t?(d=t==null?void 0:t.clientAddress)==null?void 0:d.city:"",...s("clientCity",{required:!o,pattern:/[\w ]*/i,maxLength:30})})]}),h.jsxs(W,{className:"clientPostalCode",children:[h.jsx(k,{htmlFor:"clientPostalCode",style:{color:i.clientPostalCode?"#EC5757":""},children:"Post Code"}),h.jsx(at,{id:"clientPostalCode",style:{border:i.clientPostalCode?"1px solid #EC5757":""},type:"text",defaultValue:t?(c=t==null?void 0:t.clientAddress)==null?void 0:c.postCode:"",...s("clientPostalCode",{required:!o,pattern:/^\w+[\w ]+$/i,maxLength:10,minLength:5})})]}),e<768&&h.jsx(N,{className:"client-country",children:u}),e>=768&&h.jsx(W,{className:"client-country",children:u})]})]})}function jn({invoice:t}){const{formState:{errors:e},register:i}=$(),{isDraft:s}=K();return h.jsx(h.Fragment,{children:h.jsxs(N,{className:"project-description",children:[h.jsx(k,{htmlFor:"projectDescription",style:{color:e.projectDescription?"#EC5757":""},children:"Project Description"}),h.jsx(gt,{id:"projectDescription",type:"text",defaultValue:t==null?void 0:t.description,...i("projectDescription",{required:!s}),style:{border:e.projectDescription?"1px solid #EC5757":""}})]})})}const Tn=()=>{const{id:t}=ri(),{startDate:e,setIsDraft:i,setIsNewInvoiceOpen:s,selectedPaymentOption:o,setSelectedPaymentOption:u,methods:n}=K(),{control:r,trigger:a,reset:l,watch:d,setError:c,clearErrors:m,getValues:p}=n,{replace:y}=we({control:r,name:"items"}),g=d(),[f]=St(hi,{refetchQueries:[{query:di}],onError:P=>{console.error(P)}}),[x]=St(ci,{update:(P,{data:{editInvoice:b}})=>{P.writeQuery({query:li,variables:{getInvoiceById:b.id},data:{getInvoiceById:b}})},onError:P=>{console.error(P)}}),T=()=>{u(1),l(),m(),s(!1)},E=async P=>{if(ai.flushSync(()=>i(!1)),P=p(),!P.items){c("items",{type:"custom",message:"An item must be added"});return}if(await a()){const R=ht(P,e,o);R.items=R.items.map(M=>({...M,quantity:Number(M.quantity),price:Number(M.price)})),R.status="pending";try{await f({variables:{...R}}),T(),y([{id:Dt(),name:"",quantity:0,price:0,total:0}])}catch(M){console.error(M)}}},A=async()=>{m();const P=p();P.items||(P.items=[{id:"",name:"",quantity:0,price:0,total:0}]);const b=ht(P,e,o);b.status="draft";try{await f({variables:{...b}}),T(),y([{id:Dt(),name:"",quantity:0,price:0,total:0}])}catch(R){console.error(R)}},j=async P=>{if(await a()){const R=ht(P,e,o);R.id=String(t),R.status="pending";try{await x({variables:{...R}}),s(!1)}catch(M){console.error(M)}}};return v.useEffect(()=>{g.items?m("items"):c("items",{type:"custom",message:"An item must be added"})},[g.items,c]),{methods:n,onSubmit:E,onSubmitDraft:A,onSubmitUpdate:j}},En=({children:t})=>{const e=lt();let i=700;e<=616?i=e:e<=768?i=616:i=700;const s={hidden:{x:`${-i}px`},visible:{x:"0"},exit:{x:`${-i}px`}};return h.jsxs(h.Fragment,{children:[h.jsx(he.div,{initial:{opacity:0},animate:{opacity:.5},exit:{opacity:0},transition:{duration:.3,ease:"easeInOut"},style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",backgroundColor:"#000",zIndex:1e3,cursor:"pointer"}},"overlay"),h.jsx(he.div,{variants:s,initial:"hidden",animate:"visible",exit:"exit",transition:{type:"tween",duration:.3,ease:"easeInOut"},style:{position:"fixed",top:0,left:0,width:`${i}px`,height:"100%",minHeight:"100vh",color:"#ecf0f1",padding:"20px",zIndex:1001,boxShadow:"2px 0 5px rgba(0,0,0,0.3)"},children:t},"sidebar")]})};export{yn as A,xn as C,jn as D,Pn as E,cn as F,En as S,Cn as a,W as b,vn as c,Tn as u};
