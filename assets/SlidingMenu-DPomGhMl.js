const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NewInvoiceBottomMenu-KYRwaUj9.js","assets/index-Bk9VKfhd.js","assets/index-BgypsdHM.css","assets/InvoiceStatus-Bqf6BxY4.js","assets/CancelButton-BgPWgMee.js","assets/NewInvoiceBottomMenuStyles-CGsTmVa1.js","assets/editPageStyles-Cq_TTa5l.js","assets/utilityFunctions-BqunrcK_.js","assets/useMutation-qCbIxiFn.js","assets/create-visual-element-xqrOLavL.js","assets/DateAndPayment-y2KdrZGG.js"])))=>i.map(i=>d[i]);
import{a as v,T as mi,j as c,U as Ae,V as be,W as pi,X as Re,Y as L,Z as I,a0 as et,a1 as Le,a2 as st,a3 as dt,a4 as X,a5 as Ve,a6 as fi,a7 as yi,a8 as Be,a9 as gi,aa as pt,ab as ft,ac as Rt,ad as xi,d as P,b as mt,l as vi,g as Pi,ae as ji,G as Ci,af as Ti,ag as wi,R as Ie,f as ke}from"./index-Bk9VKfhd.js";import{P as ht,e as F,c as U,f as Ei,g as Me}from"./InvoiceStatus-Bqf6BxY4.js";import{L as M,C as Fe,a as Lt,I as Ct,S as Ne,A as ut,b as Di,c as Vt,E as Si,B as Bt}from"./editPageStyles-Cq_TTa5l.js";import{c as yt,v as It}from"./utilityFunctions-BqunrcK_.js";import{u as kt}from"./useMutation-qCbIxiFn.js";import{i as O,b as Et,d as Ai,e as bi,f as Oe,p as Ri,s as Li,m as Vi,h as D,j as Tt,k as E,l as Bi,n as Ii,o as ki,q as Mt,r as $e,F as Ue,t as Ft,u as Mi,v as qe,w as ze,x as _e,y as Fi,z as Nt,S as Ni,A as Oi,B as W,C as nt,D as ot,E as Ot,G as $i,H as Ui,I as qi,J as G,K as zi,c as _i,g as Wi,a as Gi}from"./create-visual-element-xqrOLavL.js";class Hi extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=o-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Xi({children:t,isPresent:e,anchorX:i}){const s=v.useId(),o=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(mi);return v.useInsertionEffect(()=>{const{width:r,height:a,top:l,left:h,right:d}=u.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${h}`:`right: ${d}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
