const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NewInvoiceBottomMenu-CrGUOZ-G.js","assets/index-gqsUEUZH.js","assets/index-BgypsdHM.css","assets/InvoiceStatus-Ckz5f0af.js","assets/CancelButton-B8WmUUQL.js","assets/defaultValues-CHQkGAL3.js","assets/utilityFunctions-BhPDxbxW.js","assets/ReactToastify-BA45ZztF.js","assets/ReactToastify-CZOjr4-t.css","assets/editPageStyles-BwcRcRCw.js","assets/create-visual-element-CvT1qedD.js","assets/DateAndPayment-DSMARo79.js"])))=>i.map(i=>d[i]);
import{a as x,T as Je,j as l,U as fe,V as ye,W as Ke,X as ge,Y as A,Z as B,a0 as Y,a1 as xe,a2 as Z,a3 as st,a4 as z,a5 as ve,a6 as ti,a7 as ei,a8 as Pe,a9 as ii,aa as at,ab as lt,ac as Pt,ad as si,d as P,b as ot,R as je,f as Ce}from"./index-gqsUEUZH.js";import{P as Te,e as k,c as M,f as ni,g as oi}from"./InvoiceStatus-Ckz5f0af.js";import{L as V,C as we,a as jt,I as pt,S as Ee,A as nt,b as ri,c as Ct,E as ai,B as Tt}from"./editPageStyles-BwcRcRCw.js";import{i as I,b as gt,d as li,e as ci,f as De,p as di,s as hi,m as ui,h as E,j as ft,k as w,l as mi,n as pi,o as fi,q as wt,r as Se,F as Ae,t as Et,u as yi,v as be,w as Re,x as Le,y as gi,z as Dt,S as xi,A as vi,B as $,C as Q,D as J,E as St,G as Pi,H as ji,I as Ci,J as O,K as Ti,c as wi,g as Ei,a as Di}from"./create-visual-element-CvT1qedD.js";class Si extends x.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,h=this.props.sizeRef.current;h.height=i.offsetHeight||0,h.width=i.offsetWidth||0,h.top=i.offsetTop,h.left=i.offsetLeft,h.right=o-h.width-h.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Ai({children:t,isPresent:e,anchorX:i}){const s=x.useId(),o=x.useRef(null),h=x.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=x.useContext(Je);return x.useInsertionEffect(()=>{const{width:r,height:a,top:c,left:d,right:u}=h.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${d}`:`right: ${u}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
