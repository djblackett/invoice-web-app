import{a as v,T as ti,j as h,U as ve,V as Pe,W as ei,X as Ce,Y as L,Z as I,a0 as Z,a1 as je,a2 as Q,a3 as ot,a4 as z,a5 as Te,a6 as ii,a7 as si,a8 as Ee,a9 as ni,aa as ct,ab as dt,ac as Tt,ad as oi,d as C,b as lt,ae as Pt,l as ri,af as ai,G as li,ag as ci,g as di,ah as hi}from"./index-CquupEEF.js";import{P as rt,e as $,c as K,f as ui,g as we}from"./InvoiceStatus-CXApMny3.js";import{L as k,C as De,S as Se,A as at,a as mi,b as Et,c as wt,I as gt}from"./editPageStyles-B5kDS8TJ.js";import{c as ht,v as Dt}from"./utilityFunctions-BSBvP2vA.js";import{u as St}from"./useMutation-CZCbXKN2.js";import{i as F,b as Ct,d as pi,e as fi,f as Ae,p as yi,s as gi,m as xi,h as D,j as xt,k as w,l as vi,n as Pi,o as Ci,q as At,r as be,F as Re,t as bt,u as ji,v as Le,w as Ve,x as Be,y as Ti,z as Rt,S as Ei,A as wi,B as O,C as J,D as tt,E as Lt,G as Di,H as Si,I as Ai,J as U,K as bi,c as Ri,g as Li,a as Vi}from"./create-visual-element-C-cvkCrh.js";class Bi extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,o=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=o-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function Ii({children:t,isPresent:e,anchorX:i}){const s=v.useId(),o=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(ti);return v.useInsertionEffect(()=>{const{width:r,height:a,top:l,left:d,right:c}=u.current;if(e||!o.current||!r||!a)return;const m=i==="left"?`left: ${d}`:`right: ${c}`;o.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
