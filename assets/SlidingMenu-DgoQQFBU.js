import{r as v,Z as oi,j as h,$ as De,a0 as Se,a1 as ri,a2 as Ae,a3 as V,a4 as k,a5 as nt,a6 as be,a7 as rt,a8 as mt,a9 as z,aa as Re,ab as ai,ac as li,ad as Le,ae as ci,af as gt,ag as xt,ah as Lt,ai as hi,d as T,a as yt,e as di,aj as ui}from"./index-DJHl-HbE.js";import{P as pt,c as _,u as ot,d as mi,e as Ve,G as pi,E as fi,A as yi,f as gi}from"./invoice.queries-kXq_As9r.js";import{L as M,C as Be,S as Ie,A as ft,a as xi,b as Vt,c as Bt,I as wt}from"./editPageStyles-CR1zy3sT.js";import{c as vt,v as It}from"./utilityFunctions-DRkDlRDd.js";import{u as kt}from"./useMutation-QZ_RZSM4.js";import{i as F,b as bt,d as vi,e as Pi,f as ke,p as ji,s as Ci,m as Ti,h as A,j as Dt,k as S,l as Ei,n as wi,o as Di,q as Mt,r as Me,F as Fe,t as Ft,u as Si,v as Ne,w as $e,x as Oe,y as Ai,z as Nt,S as bi,A as Ri,B as O,C as at,D as lt,E as $t,G as Li,H as Vi,I as Bi,J as U,K as Ii,c as ki,g as Mi,a as Fi}from"./create-visual-element-CdEOPpzg.js";class Ni extends v.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=i.offsetParent,a=s instanceof HTMLElement&&s.offsetWidth||0,u=this.props.sizeRef.current;u.height=i.offsetHeight||0,u.width=i.offsetWidth||0,u.top=i.offsetTop,u.left=i.offsetLeft,u.right=a-u.width-u.left}return null}componentDidUpdate(){}render(){return this.props.children}}function $i({children:t,isPresent:e,anchorX:i}){const s=v.useId(),a=v.useRef(null),u=v.useRef({width:0,height:0,top:0,left:0,right:0}),{nonce:n}=v.useContext(oi);return v.useInsertionEffect(()=>{const{width:r,height:o,top:l,left:c,right:d}=u.current;if(e||!a.current||!r||!o)return;const m=i==="left"?`left: ${c}`:`right: ${d}`;a.current.dataset.motionPopId=s;const p=document.createElement("style");return n&&(p.nonce=n),document.head.appendChild(p),p.sheet&&p.sheet.insertRule(`
