import{r as P,Z as ai,j as d,$ as Ae,a0 as be,a1 as li,a2 as Re,a3 as k,a4 as rt,a5 as L,a6 as Le,a7 as lt,a8 as pt,a9 as z,aa as Ve,ab as ci,ac as di,ad as Be,ae as ui,af as vt,ag as Pt,ah as Bt,ai as hi,d as T,a as xt,e as mi,aj as fi}from"./index-vYH8fMO_.js";import{P as yt,c as W,u as at,d as pi,e as Ie,A as yi,f as gi,G as xi,E as vi}from"./invoice.queries-DdSBF33T.js";import{L as M,C as ke,S as Me,A as gt,a as Pi,b as It,c as kt,I as St}from"./editPageStyles-BAE8gon-.js";import{c as jt,v as Mt}from"./utilityFunctions-BGP96_bn.js";import{u as Ft}from"./useMutation-Do_C85-U.js";import{i as F,b as Lt,d as ji,e as Ci,f as Fe,p as Ti,s as Ei,m as wi,h as A,j as At,k as S,l as Di,n as Si,o as Nt,q as Ne,r as Ai,F as $e,t as $t,u as bi,v as Oe,w as Ue,x as qe,y as Ri,z as Ot,S as Li,A as Vi,B as O,C as ct,D as dt,E as Ut,G as Bi,H as Ii,I as ki,J as U,K as Mi,c as Fi,a as Ni,g as $i}from"./create-visual-element-B8eY67kI.js";class Oi extends P.Component{getSnapshotBeforeUpdate(e){const i=this.props.childRef.current;if(i&&e.isPresent&&!this.props.isPresent){const s=this.props.sizeRef.current;s.height=i.offsetHeight||0,s.width=i.offsetWidth||0,s.top=i.offsetTop,s.left=i.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function Ui({children:t,isPresent:e}){const i=P.useId(),s=P.useRef(null),a=P.useRef({width:0,height:0,top:0,left:0}),{nonce:m}=P.useContext(ai);return P.useInsertionEffect(()=>{const{width:n,height:o,top:r,left:l}=a.current;if(e||!s.current||!n||!o)return;s.current.dataset.motionPopId=i;const c=document.createElement("style");return m&&(c.nonce=m),document.head.appendChild(c),c.sheet&&c.sheet.insertRule(`
