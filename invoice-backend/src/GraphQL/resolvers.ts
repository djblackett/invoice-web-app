...
interface PrismaContext {
  prisma: PrismaClient
   ...
   // const prisma = container.get(DatabaseConnection).getPrisma();
  ...
  export function getResolvers(invoiceService: InvoiceService) {
    return {
      Query: {
        allInvoices: async (_parent: any, _args: any, context: PrismaContext) => {
          ...
          // console.log("Got the invoiceService from inversify container")
          try {
        ...
        getInvoiceById:
        async (_root: any, args: GetInvoiceByIdArgs) => {
    ...
    ,
      ...
      //
            ...
            editInvoice
      :
        async (_parent: any, args: Partial<Invoice>): Promise<Invoice> => {
      ...
      //     }
            ...
            createUser
      :
        async (_root: any, args: CreateUserArgs) => {
      ...
      //
            login
      :
        async (_root: any, args: LoginArgs) => {
      //
      ...
      //     }
            ...
            markAsPaid
      :
        async (_root: any, args: MarkAsPaidArgs) => {
      //
