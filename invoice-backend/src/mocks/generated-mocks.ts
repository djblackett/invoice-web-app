...
export const aClientAddress = (
  overrides?: Partial<ClientAddress>,
): ClientAddress => {
  return {
    city:
      overrides && overrides.hasOwnProperty("city") ? overrides.city! : "caste",
    country:
      overrides && overrides.hasOwnProperty("country")
        ? overrides.country!
        : "templum",
    postCode:
      overrides && overrides.hasOwnProperty("postCode")
        ? overrides.postCode!
        : "debilito",
    street:
      overrides && overrides.hasOwnProperty("street")
        ? overrides.street!
        : "eos",
  };
};
...
export const anInvoice = (overrides?: Partial<Invoice>): Invoice => {
  return {
    clientAddress:
      overrides && overrides.hasOwnProperty("clientAddress")
        ? overrides.clientAddress!
        : aClientAddress(),
    clientEmail:
      overrides && overrides.hasOwnProperty("clientEmail")
        ? overrides.clientEmail!
        : "sortitus",
    clientName:
      overrides && overrides.hasOwnProperty("clientName")
    ...
    paymentDue:
      overrides && overrides.hasOwnProperty("paymentDue")
        ...
        : "statim",
    paymentTerms:
      overrides && overrides.hasOwnProperty("paymentTerms")
        ? overrides.paymentTerms!
        : 6,
    senderAddress:
      overrides && overrides.hasOwnProperty("senderAddress")
    ...
    status:
      overrides && overrides.hasOwnProperty("status")
        ...
        : "vis",
    total:
      overrides && overrides.hasOwnProperty("total") ? overrides.total! : 9.4,
  };
};
  ...
  return {
    ...
    name:
      overrides && overrides.hasOwnProperty("name")
        ...
        : "adipiscor",
    price:
      overrides && overrides.hasOwnProperty("price") ? overrides.price! : 2.9,
    quantity:
      overrides && overrides.hasOwnProperty("quantity")
        ? overrides.quantity!
        : 4266,
    total:
      overrides && overrides.hasOwnProperty("total") ? overrides.total! : 0.3,
  };
};
  ...
  return {
    ...
    name:
      overrides && overrides.hasOwnProperty("name")
        ...
        : "centum",
    price:
      overrides && overrides.hasOwnProperty("price") ? overrides.price! : 1.1,
    quantity:
      overrides && overrides.hasOwnProperty("quantity")
        ? overrides.quantity!
        : 81,
    total:
      overrides && overrides.hasOwnProperty("total") ? overrides.total! : 2.7,
  };
};

export const aLoginResponse = (
...
export const aMutation = (overrides?: Partial<Mutation>): Mutation => {
  return {
    addInvoice:
      overrides && overrides.hasOwnProperty("addInvoice")
        ? overrides.addInvoice!
        : anInvoice(),
    createUser:
      overrides && overrides.hasOwnProperty("createUser")
        ...
        : aUser(),
    deleteAllInvoices:
      overrides && overrides.hasOwnProperty("deleteAllInvoices")
        ? overrides.deleteAllInvoices!
        : adeleteResult(),
    deleteUsers:
      overrides && overrides.hasOwnProperty("deleteUsers")
        ...
        : adeleteResult(),
    editInvoice:
      overrides && overrides.hasOwnProperty("editInvoice")
        ? overrides.editInvoice!
        : anInvoice(),
    login:
      overrides && overrides.hasOwnProperty("login")
        ...
        : aLoginResponse(),
    markAsPaid:
      overrides && overrides.hasOwnProperty("markAsPaid")
        ? overrides.markAsPaid!
        : anInvoice(),
    removeInvoice:
      overrides && overrides.hasOwnProperty("removeInvoice")
        ? overrides.removeInvoice!
        : "caterva",
  };
};
...
export const aQuery = (overrides?: Partial<Query>): Query => {
  return {
    allInvoices:
      overrides && overrides.hasOwnProperty("allInvoices")
        ? overrides.allInvoices!
        : [anInvoice()],
    allUsers:
      overrides && overrides.hasOwnProperty("allUsers")
        ? overrides.allUsers!
        : [aUser()],
    getAllClientAddresses:
      overrides && overrides.hasOwnProperty("getAllClientAddresses")
        ? overrides.getAllClientAddresses!
        : [aClientAddress()],
    getAllSenderAddresses:
      overrides && overrides.hasOwnProperty("getAllSenderAddresses")
        ? overrides.getAllSenderAddresses!
        : [aSenderAddress()],
    getInvoiceById:
      overrides && overrides.hasOwnProperty("getInvoiceById")
        ? overrides.getInvoiceById!
        : anInvoice(),
    getUserById:
      overrides && overrides.hasOwnProperty("getUserById")
...
export const aSenderAddress = (
  overrides?: Partial<SenderAddress>,
): SenderAddress => {
  return {
    city:
      overrides && overrides.hasOwnProperty("city")
...
export const aSenderInfo = (overrides?: Partial<SenderInfo>): SenderInfo => {
  return {
    city:
      overrides && overrides.hasOwnProperty("city") ? overrides.city! : "eos",
    country:
      overrides && overrides.hasOwnProperty("country")
        ? overrides.country!
        : "utrum",
...
export const aSubscription = (
  ...
  return {
    invoiceAdded:
      overrides && overrides.hasOwnProperty("invoiceAdded")
        ? overrides.invoiceAdded!
        : anInvoice(),
  };
};
...
export const adeleteResult = (
  overrides?: Partial<deleteResult>,
): deleteResult => {
  return {
    acknowledged:
      overrides && overrides.hasOwnProperty("acknowledged")
