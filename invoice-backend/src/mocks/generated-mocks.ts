...
import { ClientAddress, ClientInfo, Invoice, Item, ItemInput, Mutation, Query, SenderAddress, SenderInfo, Subscription, Token, User, deleteResult } from '../generated/graphql';
...
export const aMutation = (overrides?: Partial<Mutation>): Mutation => {
    return {
        ...
        login: overrides && overrides.hasOwnProperty('login') ? overrides.login! : aToken(),
