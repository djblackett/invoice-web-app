...
/**
 * Creates the necessary database schema for testing by executing raw SQL statements.
 *
 * @param prisma - An instance of PrismaClient connected to the test database.
 */
