...
var AllInvoicesToolbar_1 = require("./menus-toolbars/AllInvoicesToolbar");
var InvoiceGrid_1 = require("./invoice-components/InvoiceGrid");
var InvoiceCard_1 = require("./invoice-components/InvoiceCard");
...
var NewInvoice_1 = require("../old_pages/NewInvoice");
var useWindowWidth_1 = require("../hooks/useWindowWidth");
var queries_1 = require("../graphql/queries");
var AllInvoicesContainer = styled_components_1.default.div(
  templateObject_1 ||
...
function AllInvoices(_a) {
    ...
    function () {
      ...
      if (invoiceResults.data) {
        setInvoiceList(
          (_b =
            (_a =
              invoiceResults === null || invoiceResults === void 0
                ? void 0
                : invoiceResults.data) === null || _a === void 0
              ? void 0
              : _a.allInvoices) === null || _b === void 0
            ? void 0
            : _b.filter(function (invoice) {
  ...
  return (
    <AllInvoicesContainer>
      <AllInvoicesToolbar_1.MemoizedAllInvoicesToolbar
        invoiceList={invoiceList}
        setIsNewOpen={setIsNewOpen}
      />
      <NewInvoice_1.default
        isNewOpen={isNewOpen}
        setIsNewOpen={setIsNewOpen}
        padding={padding}
          ...
          {invoiceList.map(function (invoice) {
            return (
              <react_router_dom_1.Link
                key={"".concat(invoice.id, "-link")}
                to={"/".concat(invoice.id)}
