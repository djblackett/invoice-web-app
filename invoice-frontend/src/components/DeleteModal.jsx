...
exports.DarkenScreen = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  min-height: 100%;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 100;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: fixed;\n  min-height: 100%;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 100;\n"])));
...
var Confirm = styled_components_1.default.h1(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  font-weight: 700;\n  font-size: 24px;\n  line-height: 32px;\n  /* identical to box height, or 133% */\n  letter-spacing: -0.5px;\n  color: ", ";\n  margin: 0;\n  margin-bottom: 13px;\n"], ["\n  font-weight: 700;\n  font-size: 24px;\n  line-height: 32px;\n  /* identical to box height, or 133% */\n  letter-spacing: -0.5px;\n  color: ", ";\n  margin: 0;\n  margin-bottom: 13px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.text;
});
...
var ButtonContainer = styled_components_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: flex;\n  align-self: flex-end;\n  justify-content: center;\n"], ["\n  display: flex;\n  align-self: flex-end;\n  justify-content: center;\n"])));
function DeleteModal(_a) {
    var isModalOpen = _a.isModalOpen, setIsModalOpen = _a.setIsModalOpen, invoice = _a.invoice;
    ...
    return (<exports.DarkenScreen style={{ display: isModalOpen ? "flex" : "none" }}>
      <ModalContainer>
