...
exports.SVG = styled_components_1.default.svg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  width: 11px;\n  height: 11px;\n"], ["\n  width: 11px;\n  height: 11px;\n"])));
...
function NewItemButton(_a) {
    var items = _a.items, append = _a.append;
    ...
    return (<Button onClick={handleClick} type="button" style={{ border: (submitCount > 0 && items.length === 0) ? "1px solid red" : "1px solid transparent" }}>
      {/* <SVG>{plusIcon}</SVG> */}
