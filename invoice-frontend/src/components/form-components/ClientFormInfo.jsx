...
function ClientFormInfo(_a) {
  ...
  var _d = (0, react_hook_form_1.useFormContext)(),
  ...
  var clientCountry = (
    ...
    >
      ...
      <editStyles_1.CountryInput
        ...
        style={{
          border: (
            errors === null || errors === void 0 ? void 0 : errors.clientCountry
          )
            ? "1px solid #EC5757"
            : "",
          width: width < 768 ? "100%" : "",
  ...
  return (
    <>
      <LongFormEntry_1.default className="client-name">
        ...
        {((_b = errors.clientName) === null || _b === void 0
          ? void 0
          : _b.type) === "required" && (
          <editStyles_1.ErrorTextInline>
            can&apos;t be empty
          </editStyles_1.ErrorTextInline>
        )}
        <editStyles_1.Input
      ...
      <LongFormEntry_1.default className="client-email">
        ...
        {((_c = errors.clientEmail) === null || _c === void 0
          ? void 0
          : _c.type) === "pattern" && (
          <editStyles_1.ErrorTextInline
      ...
      <AddressBox_1.default>
        ...
        {width < 768 && (
          <LongFormEntry_1.default className="client-country">
            {clientCountry}
          </LongFormEntry_1.default>
        )}

        {width >= 768 && (
          <FormEntry_1.default className="client-country">
            {clientCountry}
          </FormEntry_1.default>
        )}
