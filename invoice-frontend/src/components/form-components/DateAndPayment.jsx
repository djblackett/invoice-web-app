...
var CustomDateBox = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: 48px;\n  border-radius: 4px;\n  border-color: ", ";\n  border-style: solid;\n  padding: 0 20px 0 16px;\n  margin-bottom: 1.5rem;\n  caret-color: #7C5DFA;\n  outline: none;\n  border-width: 1px;\n\n  letter-spacing: -0.25px;\n\n  color: ", ";\n  background-color: ", ";\n\n  &:focus, &:hover {\n    border-color: ", ";\n  }\n\n  .custom-input {\n    padding: 0;\n  }\n  \n  ", "\n  \n  "], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: 48px;\n  border-radius: 4px;\n  border-color: ", ";\n  border-style: solid;\n  padding: 0 20px 0 16px;\n  margin-bottom: 1.5rem;\n  caret-color: #7C5DFA;\n  outline: none;\n  border-width: 1px;\n\n  letter-spacing: -0.25px;\n\n  color: ", ";\n  background-color: ", ";\n\n  &:focus, &:hover {\n    border-color: ", ";\n  }\n\n  .custom-input {\n    padding: 0;\n  }\n  \n  ", "\n  \n  "])), function (_a) {
    var theme = _a.theme;
...
}, function (props) { return props.long && (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    width: 100%;\n  "], ["\n    width: 100%;\n  "]))); });
...
function DateAndPayment(_a) {
    ...
    var ExampleCustomInput = (0, react_1.forwardRef)(function (_a, ref) {
        ...
        return (<CustomDateBox className="custom-input" onClick={onClick} style={{ cursor: "pointer" }}>
        <DateInput ref={ref} defaultValue={value} readOnly/>
        {dateIcon}
      </CustomDateBox>);
    });
    return <editStyles_1.DateAndPaymentContainer>
      <FormEntry_1.default isLongOnMobile className="invoice-date">
        <editStyles_1.Label htmlFor="invoiceDate">
                Invoice Date
        </editStyles_1.Label>
        <react_datepicker_1.default customInput={<ExampleCustomInput />} selected={selected} onChange={onChange}/>
      </FormEntry_1.default>
      ...
      <FormEntry_1.default isLongOnMobile className="payment-terms">
        ...
        <FormDropDown_1.default isPaymentOpen={paymentOpen} handlePaymentClick={handlePaymentClick} selectedPaymentOption={selectedPaymentOption} handleChangeSelectedOption={handleChangeSelectedOption}/>
      </FormEntry_1.default>
