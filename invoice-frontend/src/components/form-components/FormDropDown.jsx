...
var DropDownList = styled_components_1.default.ul(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  position: absolute;\n  width: 100%;\n  z-index: 100;\n  padding: 0;\n  margin: 0;\n  overflow: hidden;\n  background-color: ", ";\n  box-sizing: border-box;\n  height: fit-content;\n  border-radius: 4px;\n  color: ", ";\n  font-size: 1.2rem;\n  font-weight: 600;\n  box-shadow: ", ";\n  transition: height 250ms ease-in-out;\n\n  &:first-child {\n    padding-top: 0.8em;\n  }\n\n  &:last-child {\n    border: none;\n  }\n"], ["\n  position: absolute;\n  width: 100%;\n  z-index: 100;\n  padding: 0;\n  margin: 0;\n  overflow: hidden;\n  background-color: ", ";\n  box-sizing: border-box;\n  height: fit-content;\n  border-radius: 4px;\n  color: ", ";\n  font-size: 1.2rem;\n  font-weight: 600;\n  box-shadow: ", ";\n  transition: height 250ms ease-in-out;\n\n  &:first-child {\n    padding-top: 0.8em;\n  }\n\n  &:last-child {\n    border: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ItemButton = styled_components_1.default.button(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  //position: absolute;\n  height: 100%;\n  width: 100%;\n  background-color: ", ";\n  border: none;\n  cursor: pointer;\n  outline: none;\n  font-weight: 700;\n  font-size: 12px;\n  line-height: 15px;\n  /* identical to box height, or 125% */\n  letter-spacing: -0.25px;\n  color: ", ";\n  padding: 0.5rem;\n  \n  &:first-child {\n    //padding-top: 0.8em;\n  }\n\n  &:last-child {\n    border: none;\n  }\n\n  &:hover {\n    color: #7c5dfa;\n  }\n"], ["\n  //position: absolute;\n  height: 100%;\n  width: 100%;\n  background-color: ", ";\n  border: none;\n  cursor: pointer;\n  outline: none;\n  font-weight: 700;\n  font-size: 12px;\n  line-height: 15px;\n  /* identical to box height, or 125% */\n  letter-spacing: -0.25px;\n  color: ", ";\n  padding: 0.5rem;\n  \n  &:first-child {\n    //padding-top: 0.8em;\n  }\n\n  &:last-child {\n    border: none;\n  }\n\n  &:hover {\n    color: #7c5dfa;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.paymentTermsBackground;
}, function (_a) {
    var theme = _a.theme;
...
var arrowDown = (<svg width="11" height="7" xmlns="http://www.w3.org/2000/svg">
    <path d="M1 1l4.228 4.228L9.456 1" stroke="#7C5DFA" strokeWidth="2" fill="none" fillRule="evenodd"/>
  </svg>);
function FormDropDown(_a) {
    var selectedPaymentOption = _a.selectedPaymentOption, handleChangeSelectedOption = _a.handleChangeSelectedOption, isPaymentOpen = _a.isPaymentOpen, handlePaymentClick = _a.handlePaymentClick;
    // const { id } = useParams();
    // const invoice = useSelector(state => selectInvoiceById(state, id));
    // const selectedPaymentOption = invoice?.paymentTerms || 1;
    var _b = (0, react_1.useState)("Net 1 Day"), selected = _b[0], setSelected = _b[1];
    var onOptionClicked = function (option) { return function (e) {
        e.preventDefault();
        handlePaymentClick();
    ...
    return (<Main>
      ...
      <DropDownList style={{ height: isPaymentOpen ? "192px" : 0 }} data-testid="dropDownList">
        {options.map(function (option) { return (<ListItem key={"".concat(option, "-li")} onClick={onOptionClicked(option)} data-testid={"".concat(option, "-testID")}>
            <ItemButton key={"".concat(option, "-button")} type="button">
              {options.find(function (term) { return term.includes(String(option)); })}
            </ItemButton>
          </ListItem>); })}
      </DropDownList>
    </Main>);
