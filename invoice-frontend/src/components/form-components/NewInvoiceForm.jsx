...
function NewInvoiceForm(_a) {
  var editPageWidth = _a.editPageWidth,
    startDate = _a.startDate,
    setStartDate = _a.setStartDate,
    isNewOpen = _a.isNewOpen,
    setIsNewOpen = _a.setIsNewOpen,
    isDraft = _a.isDraft,
    setIsDraft = _a.setIsDraft,
    setSelectedPaymentOption = _a.setSelectedPaymentOption,
  ...
  var register = methods.register,
    _b = methods.formState,
    errors = _b.errors,
    isSubmitSuccessful = _b.isSubmitSuccessful,
    reset = methods.reset,
  ...
  return (
    ...
    <react_hook_form_1.FormProvider {...methods}>
      <form>
        ...
        <NewInvoiceBottomMenu_1.default
