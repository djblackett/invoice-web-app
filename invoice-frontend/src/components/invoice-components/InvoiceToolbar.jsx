...
var Toolbar = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  height: 88px;\n\n  display: contents;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n\n  width: 100%;\n  z-index: 1;\n\n  @media (min-width: 600px) {\n    display: flex;\n    \n    flex-direction: row;\n    background-color: ", ";\n    border-radius: 8px;\n  }\n  \n  @media (min-width: 1200px) {\n    max-width: 730px;\n  }\n\n  box-shadow: 0 10px 10px -10px rgba(72, 84, 159, 0.100397);\n"], ["\n  height: 88px;\n\n  display: contents;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n\n  width: 100%;\n  z-index: 1;\n\n  @media (min-width: 600px) {\n    display: flex;\n    \n    flex-direction: row;\n    background-color: ", ";\n    border-radius: 8px;\n  }\n  \n  @media (min-width: 1200px) {\n    max-width: 730px;\n  }\n\n  box-shadow: 0 10px 10px -10px rgba(72, 84, 159, 0.100397);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.background;
});
var StatusContainer = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  height: 91px;\n  width: 100%;\n  padding: 10px 20px;\n  justify-content: space-between;\n  align-items: center;\n  background-color: ", ";\n  border-radius: 8px;\n\n  @media (min-width: 600px) {\n    background-color: initial;\n    justify-content: flex-start;\n  }\n"], ["\n  display: flex;\n  height: 91px;\n  width: 100%;\n  padding: 10px 20px;\n  justify-content: space-between;\n  align-items: center;\n  background-color: ", ";\n  border-radius: 8px;\n\n  @media (min-width: 600px) {\n    background-color: initial;\n    justify-content: flex-start;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.background;
});
var StatusText = styled_components_1.default.p(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  margin-right: 1rem;\n  color: ", ";\n"], ["\n  margin-right: 1rem;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.greyText;
});
function InvoiceToolbar(_a) {
    var invoice = _a.invoice, isEditOpen = _a.isEditOpen, setEdit = _a.setEdit, setIsModalOpen = _a.setIsModalOpen;
    ...
    return (<Toolbar className="invoice-toolbar" style={{
      ...
      <ToolbarButtons_1.default toggleEditTab={setEdit} isEditOpen={isEditOpen} invoice={invoice} openModal={openModal}/>
    </Toolbar>);
}
