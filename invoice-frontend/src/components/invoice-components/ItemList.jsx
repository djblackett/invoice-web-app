...
var ListContainer = styled_components_1.default.div(
  templateObject_1 ||
...
var AmountDue = styled_components_1.default.div(
  templateObject_2 ||
...
var AmountDueTitle = styled_components_1.default.p(
  templateObject_3 ||
...
var AmountDueTotal = styled_components_1.default.p(
  templateObject_4 ||
...
var ItemsHeader = styled_components_1.default.div(
  templateObject_5 ||
...
var Col = styled_components_1.default.p(
  templateObject_6 ||
...
var Col1 = (0, styled_components_1.default)(Col)(
  templateObject_7 ||
...
var ItemsContainer = styled_components_1.default.div(
  templateObject_8 ||
    ...
    <ListContainer>
      ...
      <ItemsContainer>
        {invoice.items.map(function (item) {
          return (
            <InvoiceItem_1.default
              item={item}
              key={"itemList-".concat(item.id || ++count)}
            />
          );
        })}
      </ItemsContainer>
      <AmountDue>
        ...
        <AmountDueTotal>
          £ {(0, utilityFunctions_1.getMoney)(invoice.total)}
        </AmountDueTotal>
      </AmountDue>
    </ListContainer>
  );
