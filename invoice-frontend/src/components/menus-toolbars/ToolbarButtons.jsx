...
function ToolbarButtons(_a) {
    var toggleEditTab = _a.toggleEditTab, invoice = _a.invoice, openModal = _a.openModal, isEditOpen = _a.isEditOpen;
    return (<ButtonsContainer>
      <EditButton_1.default toggleEditTab={toggleEditTab} isEditOpen={isEditOpen}/>
