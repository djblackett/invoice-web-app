...
var formOptions = { resolver: (0, yup_1.yupResolver)(schemas_1.validationSchema) };
function EditForm(_a) {
    var isEditOpen = _a.isEditOpen, setIsEditOpen = _a.setIsEditOpen, padding = _a.padding, setPadding = _a.setPadding;
    var methods = (0, react_hook_form_1.useForm)(__assign(__assign({}, formOptions), { mode: "onChange" }));
    var register = methods.register, handleSubmit = methods.handleSubmit, errors = methods.formState.errors, getValues = methods.getValues, watch = methods.watch, trigger = methods.trigger, reset = methods.reset, setError = methods.setError, clearErrors = methods.clearErrors;
    ...
    var _b = (0, react_1.useState)(0), editPageWidth = _b[0], setEditPageWidth = _b[1];
    var _c = (0, react_1.useState)((0, utilityFunctions_1.convertStringToDate)(invoice === null || invoice === void 0 ? void 0 : invoice.createdAt)), startDate = _c[0], setStartDate = _c[1];
    var _d = (0, react_1.useState)((invoice === null || invoice === void 0 ? void 0 : invoice.paymentTerms) || 1), selectedPaymentOption = _d[0], setSelectedPaymentOption = _d[1];
    var _e = (0, react_1.useState)(false), isPaymentOpen = _e[0], setIsPaymentOpen = _e[1];
    ...
    var onSubmit = function () {
        ...
        trigger()
            ...
            if (value) {
                ...
                var newInvoice = (0, utilityFunctions_1.createInvoiceObject)(data, startDate, selectedPaymentOption, id, invoice);
    ...
    return (<editStyles_1.DarkenScreen style={{ visibility: isEditOpen ? "visible" : "hidden" }}>
      <editStyles_1.FormContainerDarkenModal style={{
        ...
        <react_hook_form_1.FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column" }}>
            ...
            <CompanyFormInfo_1.CompanyFormInfo invoice={invoice} editPageWidth={editPageWidth} isDraft={false}/>

            {/* //  Client details */}
            <editStyles_1.BillText>Bill To</editStyles_1.BillText>
            <ClientFormInfo_1.default editPageWidth={editPageWidth} invoice={invoice} isDraft={false}/>

            <DateAndPayment_1.default selected={startDate} onChange={function (date) { return setStartDate(date); }} paymentOpen={isPaymentOpen} handlePaymentClick={handlePaymentClick} selectedPaymentOption={selectedPaymentOption} handleChangeSelectedOption={handleChangeSelectedOption}/>
            ...
            <LongFormEntry_1.default className="project-description">
              ...
              <editStyles_1.Input 
    // long
    type="text" defaultValue={invoice === null || invoice === void 0 ? void 0 : invoice.description} {...register("projectDescription", { required: true })} style={{
            border: errors.projectDescription ? "1px solid #EC5757" : "",
        }}/>
            </LongFormEntry_1.default>

            <EditFormItemList_1.default invoice={invoice} isEditOpen={isEditOpen} isDraft={false}/>


            <FormErrorList_1.default isEditOpen={isEditOpen}/>

            <EditBottomMenu_1.default setIsOpen={setIsEditOpen} saveText="Save Changes" closeText="Cancel" 
    // invoice={invoice}
    onSubmit={onSubmit} justifyCancel=""/>
          </form>
