...
function NewInvoice(_a) {
    var isNewOpen = _a.isNewOpen, setIsNewOpen = _a.setIsNewOpen, padding = _a.padding, setPadding = _a.setPadding;
    var width = (0, useWindowWidth_1.default)();
    // initial state and default values for form
    var _b = (0, react_1.useState)(true), isDraft = _b[0], setIsDraft = _b[1];
    var _c = (0, react_1.useState)(width), editPageWidth = _c[0], setEditPageWidth = _c[1];
    var _d = (0, react_1.useState)(new Date()), startDate = _d[0], setStartDate = _d[1];
    var _e = (0, react_1.useState)([]), items = _e[0], setItems = _e[1];
    var _f = (0, react_1.useState)(1), selectedPaymentOption = _f[0], setSelectedPaymentOption = _f[1];
    ...
    (0, react_1.useLayoutEffect)(function () {
        var newItems = items.map(function (item) { return (__assign(__assign({}, item), { id: (0, uuid_1.v4)() })); });
        setItems(newItems);
    }, []);
    return (
    // DarkenScreen appears when newInvoice tab is open
    <editStyles_1.DarkenScreen style={{ visibility: isNewOpen ? "visible" : "hidden" }}>
      <editStyles_1.FormContainerDarkenModal style={{
        ...
        <NewInvoiceForm_1.default startDate={startDate} setStartDate={setStartDate} isNewOpen={isNewOpen} setIsNewOpen={setIsNewOpen} editPageWidth={editPageWidth} isDraft={isDraft} setIsDraft={setIsDraft} selectedPaymentOption={selectedPaymentOption} setSelectedPaymentOption={setSelectedPaymentOption}/>
