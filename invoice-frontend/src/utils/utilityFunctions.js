...
exports.createInvoiceObject =
  exports.convertStringToDate =
  exports.convertDateToString =
  exports.convertedDate =
  exports.getMoney =
  exports.getCurrency =
  exports.generateId =
    void 0;
...
var convertDateToString = function (date) {
  var _a = [date.getMonth(), date.getDate(), date.getFullYear()],
    month = _a[0],
    day = _a[1],
    year = _a[2];
...
var createInvoiceObject = function (
  data,
  startDate,
  ...
  var newInvoice = {
    ...
    paymentTerms: 0,
    status:
      (invoice === null || invoice === void 0 ? void 0 : invoice.status) ||
      "draft",
    total: 0,
  };
  var invoiceTotal = 0;
